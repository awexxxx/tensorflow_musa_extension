...
#ifndef TENSORFLOW_MUSA_EXTENSION_GRAPH_FUSION_PROD_NORM_ACT_FUSION_H_
#define TENSORFLOW_MUSA_EXTENSION_GRAPH_FUSION_PROD_NORM_ACT_FUSION_H_
...
class MusaProdNormActFusion : public FusionPattern {
 public:
  MusaProdNormActFusion();
  ~MusaProdNormActFusion() override = default;
  ...
  std::string GetName() const override { return "MusaProdNormActFusion"; }
...
#endif  // TENSORFLOW_MUSA_EXTENSION_GRAPH_FUSION_PROD_NORM_ACT_FUSION_H_
